...
func (x *Request) GetQueryParams() map[string]string {
	if x != nil {
...
var file_ingress_proto_rawDesc = []byte{
	...
	0x66, 0x65, 0x73, 0x74, 0x52, 0x65, 0x71, 0x22, 0xff, 0x03, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x12, 0x37, 0x0a, 0x07,
	...
	0x79, 0x52, 0x0b, 0x71, 0x75, 0x65, 0x72, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x1a, 0x3a,
	...
	0x74, 0x68, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a,
	...
	0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12,
	0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xac, 0x01, 0x0a, 0x08, 0x52, 0x65,
	...
	0x64, 0x79, 0x12, 0x38, 0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x2e, 0x52, 0x65,
	...
	,
...
var file_ingress_proto_goTypes = []interface{}{
	...
	(*Response)(nil),          // 2: ingress.Response
	nil,                       // 3: ingress.Request.HeadersEntry
	nil,                       // 4: ingress.Request.PathParamsEntry
	nil,                       // 5: ingress.Request.QueryParamsEntry
	nil,                       // 6: ingress.Response.HeadersEntry
	(manifest.HttpMethod)(0),  // 7: manifest.HttpMethod
	(*manifest.Manifest)(nil), // 8: manifest.Manifest
}
var file_ingress_proto_depIdxs = []int32{
	7, // 0: ingress.Request.http_method:type_name -> manifest.HttpMethod
	3, // 1: ingress.Request.headers:type_name -> ingress.Request.HeadersEntry
	4, // 2: ingress.Request.path_params:type_name -> ingress.Request.PathParamsEntry
	5, // 3: ingress.Request.query_params:type_name -> ingress.Request.QueryParamsEntry
	6, // 4: ingress.Response.headers:type_name -> ingress.Response.HeadersEntry
	0, // 5: ingress.FoldIngress.GetManifest:input_type -> ingress.ManifestReq
	1, // 6: ingress.FoldIngress.DoRequest:input_type -> ingress.Request
	8, // 7: ingress.FoldIngress.GetManifest:output_type -> manifest.Manifest
	2, // 8: ingress.FoldIngress.DoRequest:output_type -> ingress.Response
